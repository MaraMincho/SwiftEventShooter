...
/// White box tests
final class CustomEventStreamControllerTest: XCTestCase {
  ...
  func test_withMockStruct() async throws {
    ...
    controller = CustomEventStreamController(
      targetType: CustomEventStreamControllerTargetType(baseURL: "Test", path: nil, method: .post, body: nil, headers: [:]),
      provider: .init(session: mockSession),
      networkURLString: "https://exmpale.com",
...
extension CustomEventStreamControllerTest {
  struct CustomEventStreamControllerTargetType: NetworkTargetType, @unchecked Sendable {
    var baseURL: String
    var path: String?
    var method: SwiftEventShooter.HTTPMethod
    var body: Encodable?
    var headers: [String : String]

    init(baseURL: String, path: String?, method: SwiftEventShooter.HTTPMethod, body: (any Encodable)?, headers: [String : String]) {
